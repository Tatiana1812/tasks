...
public class UIManagerKeyChecker implements ActionListener, ItemListener
{
...
//				System.out.println(e.getStackTrace()[0]);
	...
	{
		private UIManagerKeyChecker defaults;
		private String laf;

		protected ChangeLookAndFeelAction(UIManagerKeyChecker defaults, String laf, String name)
		{
	...
	{
		UIManagerKeyChecker application = new UIManagerKeyChecker();
