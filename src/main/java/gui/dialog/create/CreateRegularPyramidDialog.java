 ...
 * Using PyramidRegularBuilder
 * @author alexeev
 */
public class CreateRegularPyramidDialog extends CreateBodyDialog {
  ...
  public CreateRegularPyramidDialog(EdtController ctrl, i_ErrorHandler errorHandler) {
    super(ctrl, errorHandler, "Построить правильную пирамиду");
      ...
      public void actionPerformed(ActionEvent ae) {
        try {
          if (!(_vertexQtyField.verify()) ||
            ...
            _ctrl.add(new PyramidRegularBuilder(params), _errorHandler, false);
            accepted = true;
            CreateRegularPyramidDialog.this.dispose();
          }
        }
