 ...
 * @author alexeev
 */
public class CreateLineParallelLineDialog extends CreateBodyDialog {
  /**
   *
   * @param ctrl
   */
  public CreateLineParallelLineDialog(EdtController ctrl, i_ErrorHandler errorHandler) {
    super(ctrl, errorHandler, "Провести прямую параллельно другой прямой");
  ...
  protected AbstractAction OKAction() {
    return new AbstractAction() {
      ...
      public void actionPerformed(ActionEvent ae) {
        ...
        _ctrl.add(new LineParallelLineBuilder(params), _errorHandler, false);
        accepted = true;
        dispose();
      }
    };
