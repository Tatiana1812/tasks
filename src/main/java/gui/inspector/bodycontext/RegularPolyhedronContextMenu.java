 ...
 * @author alexeev
 */
public class RegularPolyhedronContextMenu extends BodyContextMenu {
  public RegularPolyhedronContextMenu(EdtController ctrl, final String bodyID) throws ExNoBody {
    super(ctrl, bodyID);
