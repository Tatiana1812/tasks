 ...
 * @author kaznin
 */
public class StellaOctahedronContextMenu extends BodyContextMenu {
  public StellaOctahedronContextMenu(EdtController ctrl, final String bodyID) throws ExNoBody {
    super(ctrl, bodyID);
