 ...
 * @author Elena
 */
public class LineOrthogonalLine2dBuilder extends BodyBuilder {
  static public final String ALIAS = "LineOrthogonalLine2d";

  public LineOrthogonalLine2dBuilder() {
  }

  public LineOrthogonalLine2dBuilder(String id, String name) {
    super(id, name);
  }

  public LineOrthogonalLine2dBuilder(String id, HashMap<String, BuilderParam> params) {
    super(id, params);
  }

  public LineOrthogonalLine2dBuilder(String id, String name, JsonObject param) {
    super(id, name);
    setValue(BLDKEY_P, param.get(BLDKEY_P).asString());
    setValue(BLDKEY_LINE, param.get(BLDKEY_LINE).asString());
  }

  public LineOrthogonalLine2dBuilder(HashMap<String, BuilderParam> params) {
    super(params);
  }
  ...
  public i_Body create(Editor edt, i_ErrorHandler eh){
    ...
    try {
      ...
      Line3d line = Line3d.linePerpendicularLine2d(l.line(), anchors.getVect(getValueAsString(BLDKEY_P)));
