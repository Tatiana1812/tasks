 ...
 * @author gayduk
 */
public class SphereInIcosahedronBuilder extends BodyBuilder {
  static public final String ALIAS = "SphereInIcosahedron";
  
  public SphereInIcosahedronBuilder() {
  }
  
  public SphereInIcosahedronBuilder(String id, String name) {
    super(id, name);
  }

  public SphereInIcosahedronBuilder(String id, HashMap<String, BuilderParam> params) {
    super(id, params);
  }

  public SphereInIcosahedronBuilder(String id, String name, JsonObject param) {
    super(id, name);
    setValue(BLDKEY_ICOSAHEDRON, param.get(BLDKEY_ICOSAHEDRON).asString());
  }

  public SphereInIcosahedronBuilder(HashMap<String, BuilderParam> params) {
    super(params);
  }
  ...
  public i_Body create (Editor edt, i_ErrorHandler eh){
    ...
    try {
      ...
      SphereBody result = new SphereBody(_id, title(), ico.icosahedron().inSphere());
  ...
  public String description(EdtController ctrl, int precision) {
    try {
      return String.format("<html><strong>Сфера</strong> <br>вписанная в икосаэдр %s",
