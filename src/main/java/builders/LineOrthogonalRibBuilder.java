 ...
 * @author Elena
 */
public class LineOrthogonalRibBuilder extends BodyBuilder {
  static public final String ALIAS = "LineOrthogonalRib";

  public LineOrthogonalRibBuilder() {
  }

  public LineOrthogonalRibBuilder(String id, String name) {
    super(id, name);
  }

  public LineOrthogonalRibBuilder(String id, HashMap<String, BuilderParam> params) {
    super(id, params);
  }

  public LineOrthogonalRibBuilder(String id, String name, JsonObject param) {
    super(id, name);
    setValue(BLDKEY_P, param.get(BLDKEY_P).asString());
    setValue(BLDKEY_RIB, param.get(BLDKEY_RIB).asString());
  }

  public LineOrthogonalRibBuilder(HashMap<String, BuilderParam> params) {
    super(params);
  }
  ...
  public i_Body create(Editor edt, i_ErrorHandler eh){
    ...
    try {
      ...
      Line3d line = Line3d.linePerpendicularLine(rib.line(), anchors.getVect(getValueAsString(BLDKEY_P)));
