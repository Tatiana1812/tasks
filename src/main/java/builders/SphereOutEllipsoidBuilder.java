...
/**
 * Circumscribes sphere around ellipsoid
 * @author Vitaliy
 */
public class SphereOutEllipsoidBuilder extends BodyBuilder {
  static public final String ALIAS = "SphereOutEllipsoid";

  public SphereOutEllipsoidBuilder() {
  }

  public SphereOutEllipsoidBuilder(String id, String name) {
    super(id, name);
  }

  public SphereOutEllipsoidBuilder(String id, HashMap<String, BuilderParam> params) {
    super(id, params);
  }

  public SphereOutEllipsoidBuilder(String id, String name, JsonObject param) {
    super(id, name);
    setValue(BLDKEY_ELLIPSOID, param.get(BLDKEY_ELLIPSOID).asString());
  }

  public SphereOutEllipsoidBuilder(HashMap<String, BuilderParam> params) {
    super(params);
  }
  ...
  public i_Body create(Editor edt, i_ErrorHandler eh) {
    ...
    try {
      ...
      SphereBody result = new SphereBody(_id, title(), el.outSphere());
  ...
  public String description(EdtController ctrl, int precision) {
    try {
      return String.format("<html><strong>Сфера</strong> <br>описанная около эллипсоида %s",
